                    ...
                    <>
                        <div className="first flex justify-center flex-wrap items-center   gap-x-[50px]">
                            ...
                            <div className="inner ">
                                ...
                                <p className="text-2xl mb-[10px]">Category: <span className=" text-upper">{item.strCategory}</span></p>
                                <p className="text-2xl mb-[10px]">Area: <span className="">{item.strArea}</span></p>
